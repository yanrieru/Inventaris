...
<head>
    ...
    <title>Cetak Laporan Reparasi Selesai</title>
</head>
...
<body>
    ...
    $query = mysqli_query($con,"SELECT x.*, x1.nama_kerusakan, x1.harga_perbaikan, x2.nama FROM tb_perbaikan x JOIN tb_jenis_kerusakan x1 ON x1.id_kerusakan = x.id_kerusakan JOIN tb_kasir x2 ON x2.id_kasir = x.id_kasir WHERE x.tanggal >= '$tanggal_awal' AND x.tanggal <= '$tanggal_akhir' ORDER BY x.tanggal ASC")or die(mysqli_error($con));
